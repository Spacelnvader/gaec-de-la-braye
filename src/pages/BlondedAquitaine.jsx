...
function BlondedAquitaine() {
    return(
        ...
        <h3>Pourquoi préférer la blonde d'Aquitaine?</h3>
            <article>Race bovine de grand format dédiée à la production de viande, la Blonde d'Aquitaine ne cesse de se développer depuis sa création en 1962. Vache à viande spécialisée à fort développement corporel, la Blonde d'Aquitaine exprime une musculature puissante et rebondie, une ossature fine. Elle génère une croissance remarquable à tous les âges, avec du gabarit et un gros potentiel musculaire. Animal docile dans la plupart des cas (pas toutes mignonnes mais presque !) et facile d'entretien.</article>
